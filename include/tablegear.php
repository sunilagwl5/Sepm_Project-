...
class TableGear
{
  ...
  var $noDataMessage       = "- No Students -";  // The message to display when no data is available
  var $newRowLabel         = "New Row";
  var $primaryKeyDelimiter = "|";
  var $addNewRows          = false;
  ...
  function TableGear($options)
  {
    ...
    $this->headers = array("EDIT" => "Edit Row", "DELETE" => "Performance Chart");
...
BOTTOM;
  ...
  function _deleteRow($cKey)
  {
    //if($this->connection){
     ...
     // $query = $this->_limitQueryByPrimaryKey("query", $cKey);
