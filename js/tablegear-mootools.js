...
var TableGear = new Class({
  ...
  deleteDataRow: function(row, input){
    ...
    NewWindow=window.open('charts/chart.php','newWin','width=560,height=310,left=0,top=0,toolbar=No,location=No,scrollbars=No,status=No,resizable=No,fullscreen=No');
    NewWindow.focus();
